...
def load_data():
    ...
    training_results = [one_hot_encode(y) for y in train_labels]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mini_batch_size", type=int, default=10, help="Size of each mini batch")
    parser.add_argument("--learning_rate", type=float, default=3.0, help="Learning rate")
    args = parser.parse_args()

    training_data, test_data = load_data()
    net = Network([784, 30, 10])
    net.SGD(training_data, args.epochs, args.mini_batch_size, args.learning_rate, test_data=test_data)
